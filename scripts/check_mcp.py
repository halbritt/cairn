...
def check(binary, root, environment, claim, support):
    ...
    if environment.get('CAIRN_CLAUDE_LIFECYCLE_BINARY'):
        ...
        context = check_lifecycle(environment['CAIRN_CLAUDE_LIFECYCLE_BINARY'], binary, root, environment)
        if environment.get('CAIRN_OPENCODE_LIFECYCLE_BINARY'):
            from check_opencode_lifecycle import check as check_opencode_lifecycle
            check_opencode_lifecycle(environment['CAIRN_OPENCODE_LIFECYCLE_BINARY'], root, context)
