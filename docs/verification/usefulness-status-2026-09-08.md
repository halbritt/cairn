...
| --- | --- | --- |
| [Explicit browsing](browse-2026-09-09.md): the installed CLI and native OpenCode/Codex interfaces return eligible previews without query vocabulary, followed by an exact body pull. | A usable discovery route through the existing scoped index. | Budget limits can omit older notes; no pagination, independent model adoption or task-result improvement is established. |
