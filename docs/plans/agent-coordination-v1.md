...
| 5. Wake operations | Structured context and per-slot launch spacing/backoff deployed; read-only cursor watch implemented and verified; expanded recovery views pending. |
