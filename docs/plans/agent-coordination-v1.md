...
| 5. Wake operations | Structured context and per-slot launch spacing/backoff deployed; read-only cursor watch deployed; operator review/reissue verified, rollout pending. |
