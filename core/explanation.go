...
func omissionCensus() map[string]int {
	return map[string]int{"CLASS_NOT_CONSEQUENTIAL": 0, "AUTHORITY_INACTIVE": 0, "POLICY_UNENFORCEABLE": 0, "OPEN_CONFLICT": 0, "ATTRIBUTION_UNRECONCILED": 0, "EVIDENCE_UNAVAILABLE": 0, "NO_LEXICAL_MATCH": 0, "REDUNDANT": 0, "OPTIONAL_BUDGET": 0, "TOTAL_BUDGET": 0}
}
