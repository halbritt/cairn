...
func main() {
	...
	if err != nil {
		...
		case "NOT_FOUND":
			exitCode = 3
		case "PAYLOAD_UNAVAILABLE", "DEPENDENCY_CONFLICT", "STALE_HANDLE", "STALE_PROPOSAL", "STALE_PREVIEW", "VERSION_CONFLICT", "IDEMPOTENCY_CONFLICT", "SCHEMA_MISMATCH", "STALE_PACKAGE", "RUN_ALREADY_STARTED":
			exitCode = 4
