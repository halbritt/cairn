...
func main() {
	...
	if err != nil {
		...
		case "AUTHORITY_DENIED", "SELF_PROMOTION_DENIED":
			exitCode = 6
		case "IMPACT_PREVIEW_REQUIRED", "BUDGET_REFUSED", "POLICY_UNENFORCEABLE", "OPEN_CONFLICT", "DESTINATION_PROHIBITED", "EVIDENCE_UNAVAILABLE", "ATTRIBUTION_UNRECONCILED", "ATTRIBUTION_CONTRADICTED":
			exitCode = 2
		default:
			exitCode = 7
