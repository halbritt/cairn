...
func main() {
	...
	if err != nil {
		...
		case "NOT_FOUND":
			exitCode = 3
		case "ARTIFACT_CHANGED", "ARTIFACT_UNSAFE", "PAYLOAD_UNAVAILABLE", "DEPENDENCY_CONFLICT", "STALE_HANDLE", "STALE_PROPOSAL", "STALE_PREVIEW", "VERSION_CONFLICT", "IDEMPOTENCY_CONFLICT", "SCHEMA_MISMATCH", "STALE_PACKAGE", "RUN_ALREADY_STARTED":
			exitCode = 4
		case "AUTHORITY_DENIED", "SELF_PROMOTION_DENIED":
			exitCode = 6
		case "REPLAY_INCOMPLETE", "IMPACT_PREVIEW_REQUIRED", "BUDGET_REFUSED", "POLICY_UNENFORCEABLE", "OPEN_CONFLICT", "DESTINATION_PROHIBITED", "EVIDENCE_UNAVAILABLE", "ATTRIBUTION_UNRECONCILED", "ATTRIBUTION_CONTRADICTED":
			exitCode = 2
		default:
			exitCode = 7
